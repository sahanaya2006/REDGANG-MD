...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '𝐑𝐄𝐃𝐆𝐀𝐍𝐆-𝐌𝐃' : process.env.BOT_NAME,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'Redgang-Md' : process.env.PACK_INFO.split(";")[1],
  ...
  LANG: process.env.THEME|| 'REDGANG',
