...
module.exports = {
  ...
  HEROKU: {
    ...
    API_KEY: process.env.HEROKU_API_KEY === undefined ? 'a8149aa3-ba4a-43ba-9278-685a02d2f929' : process.env.HEROKU_API_KEY,
    APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'sector250' : process.env.HEROKU_APP_NAME
},
