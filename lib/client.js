...
try {
    ...
    console.log("🌍 Connected to the REDGANG DB");
} catch {
...
let cc = Config.sessionName.replace(/SAVIYA-MD;;;/g, "").replace(/REDGANG-MD;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    console.log("⬇️  REDGANG MD Installing External Plugins...");
                    ...
                    for (let i = 0; i < check.length; i++) {
                     ...
                     console.log("😁  REDGANG External Plugins Installed!");fs.readdirSync(__dirname + "/../commands").forEach((plugin) => {
