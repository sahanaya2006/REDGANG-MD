...
try {
    ...
    console.log("📡Connected to the REDGANG-MD SERVER")
} catch {
...
let cc = Config.sessionName.replace(/REDGANG;;;/g, "");
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://github.com/https://github.com/sahanaya2006/REDGANG-MD')
	}
    }
    main()
    //========================================================================================================================================
...
await updateStatus()
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    console.log("✅ REDGANG-MD Login Successful!");
                    ...
                    console.log("✅ Redgang-Md External Plugins Installed!");
...
app.listen(port, () => console.log(`REDGANG Server listening on port http://localhost:${port}!`));
