...
let cc = Config.sessionName.replace(/REDGANG;;;/gi, "").replace(/Secktor;;;/gi, ""); // Dont Remove "Secktor;;;" So that You Can Use Secktor Qr too in your bot
...
setTimeout(() => {
    ...
    async function main() {
        ...
        catch {console.log('Could not connect with Mongodb.\nPlease visit https://github.com/sahanaya2006/REDGANG-MD')}
    }
    main()
    //========================================================================================================================================
